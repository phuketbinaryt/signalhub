...
export function ActionsDropdown({ trade, onDelete, onComplete }: ActionsDropdownProps) {
        ...
        {isOpen && (
          <div className="absolute right-0 mt-1 w-40 bg-[#1a1a1a] border border-[#333] rounded-lg shadow-lg z-50">
            ...
            <button
              ...
              className={`w-full flex items-center gap-2 px-3 py-2 text-sm text-red-400 hover:bg-[#2a2a2a] transition-colors ${isOpenTrade ? '' : 'rounded-t-lg'} rounded-b-lg`}
            >
